...
# wget -q -O - --header="Content-Type: application/json" --post-data="${POST_DATA}" "${TESTURL}/_admin/api/v1/category/getmany"
${HTTPIE} POST "${TESTURL}/_admin/api/v1/category/getmany" <<< "$POST_DATA"
