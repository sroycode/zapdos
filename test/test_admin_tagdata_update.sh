...
# wget -q -O - --header="Content-Type: application/json" --post-data="${POST_DATA}" "${TESTURL}/_admin/api/v1/tagdata/update"
${HTTPIE} POST "${TESTURL}/_admin/api/v1/tagdata/update" <<< "$POST_DATA"
